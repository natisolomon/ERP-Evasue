// src/components/inventory/shipments/InventoryShipmentFilters.tsx
'use client';

interface InventoryShipmentFiltersProps {
  filters: {
    type: string;
    status: string;
    carrier: string;
...
export function InventoryShipmentFilters({ filters, setFilters }: InventoryShipmentFiltersProps) {
  return (
