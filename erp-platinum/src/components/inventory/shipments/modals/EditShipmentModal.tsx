// src/components/inventory/shipments/InventoryShipmentModal/EditShipmentModal.tsx
'use client';
...
export function EditShipmentModal({ shipment, onClose }: EditShipmentModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Update shipment:', updatedShipment);
    onClose();
  };
      ...
      >
        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-secondary mt-2">Update the details for this shipment</p>
          </div>
            ...
            <div className="flex-1 overflow-y-auto pr-2">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2 text-secondary">Actual Delivery</label>
                    <input
                      type="date"
