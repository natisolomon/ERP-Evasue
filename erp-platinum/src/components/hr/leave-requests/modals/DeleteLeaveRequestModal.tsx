// src/components/hr/leave-requests/HRLeaveRequestModal/DeleteLeaveRequestModal.tsx
'use client';
...
export function DeleteLeaveRequestModal({ request, onClose }: DeleteLeaveRequestModalProps) {
  useEffect(() => {
  ...
  const handleDelete = () => {
    console.log('Delete leave request:', request.id);
    onClose();
  };
          ...
          >
            ...
            <div className="text-center py-8">
              ...
              <p className="text-secondary mb-6 text-lg">
                ...
                <br />
                <span className="font-medium text-primary block mt-2">{request.staffName}</span>
