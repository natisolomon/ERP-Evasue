// src/components/finance/transactions/FinanceTransactionModal/DeleteTransactionModal.tsx
'use client';
        ...
        >
          ...
          >
            ...
            <div className="text-center py-8">
              ...
              <h2 className="text-3xl font-bold text-primary mb-4">Delete Transaction?</h2>
              <p className="text-secondary mb-6 text-lg">
                Are you sure you want to permanently delete this transaction?
                <br />
                <span className="font-medium text-primary block mt-2">"{transaction.description}"</span>
                <span className="text-sm text-secondary block mt-1">Reference: {transaction.reference}</span>
              </p>
