// src/components/finance/transactions/FinanceTransactionModal/AddTransactionModal.tsx
'use client';
      ...
      >
        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-secondary mt-2">Record a new financial transaction</p>
          </div>
