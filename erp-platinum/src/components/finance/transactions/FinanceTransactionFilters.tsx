// src/components/finance/transactions/FinanceTransactionFilters.tsx
'use client';
...
export function FinanceTransactionFilters({ filters, setFilters }: FinanceTransactionFiltersProps) {
  return (
