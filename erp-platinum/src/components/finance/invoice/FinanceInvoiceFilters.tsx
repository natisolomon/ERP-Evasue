// src/components/finance/invoices/FinanceInvoiceFilters.tsx
'use client';

interface FinanceInvoiceFiltersProps {
  filters: {
    status: string;
    client: string;
    search: string;
...
export function FinanceInvoiceFilters({ filters, setFilters }: FinanceInvoiceFiltersProps) {
  return (
    <div className="glass rounded-3xl p-6 border border-default mb-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium mb-2 text-secondary">Client</label>
          <input
            type="text"
