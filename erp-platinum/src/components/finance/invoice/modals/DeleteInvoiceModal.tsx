// src/components/finance/invoices/FinanceInvoiceModal/DeleteInvoiceModal.tsx
'use client';
        ...
        >
          ...
          >
            ...
            <div className="text-center py-8">
              ...
              <h2 className="text-3xl font-bold text-primary mb-4">Delete Invoice?</h2>
              <p className="text-secondary mb-6 text-lg">
                Are you sure you want to permanently delete this invoice?
                <br />
                <span className="font-medium text-primary block mt-2">{invoice.invoiceNumber}</span>
                <span className="text-sm text-secondary block mt-1">Client: {invoice.client.name}</span>
              </p>
