// src/components/admin/hr/HRModal/DeleteEmployeeModal.tsx
'use client';
      ...
      >
        ...
        >
          ...
          <div className="text-center py-8">
            ...
            <h2 className="text-3xl font-bold text-primary mb-4">Delete Employee?</h2>
            <p className="text-secondary mb-6 text-lg">
              ...
              <span className="text-sm text-secondary block mt-1">{employee.email}</span>
            </p>
